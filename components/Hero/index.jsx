...
const Hero = () => {
  return (
    <div className="py-12 px-2 max-w-4xl m-auto sm:pt-24">
        ...
        Backend Software Engineer with 2+ years of experience, adept at crafting innovative solutions using
Microservices, REST Framework, Spring, and Java. Demonstrates proficiency in driving excellence in software
development. Skilled in sculpting efficient and scalable backend solutions. Dedicated to delivering high-quality
results in the dynamic field of software engineering.
        </p>
        <div className="my-7 flex justify-start items-center gap-4 flex-wrap">
          <button className="bg-teal-500 py-2 px-4 font-bold text-white border-2 border-teal-500 rounded-md ease-in-out duration-150 hover:text-white hover:bg-transparent hover:border-white" title="View Resume">
            <a href="https://drive.google.com/file/d/11HWbyM7Rp8Psy62Ex3kOByVemjTqiRI7/view" className="flex justify-start items-center gap-1">
        ...
        <div className="flex flex-col justify-start items-start gap-3">
          ...
          <ul className="flex justify-start items-center flex-wrap gap-4">
            <li title="Twitter">
              <a href="https://twitter.com/abhinavkhandel6" className="text-teal-500 text-md ease-in-out duration-150 hover:text-white">
                <FiTwitter />
              </a>
            </li>
            <li title="GitHub">
              <a href="https://github.com/abhi24gupta" className="text-teal-500 text-md ease-in-out duration-150 hover:text-white">
                <FiGithub />
              </a>
            </li>
            <li title="LinkedIn">
              <a href="https://www.linkedin.com/in/abhinav-gupta-583057174/" className="text-teal-500 text-md ease-in-out duration-150 hover:text-white">
                <FiLinkedin />
              </a>
            </li>
          </ul>
